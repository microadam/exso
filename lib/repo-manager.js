...
var PullRequest = require('./models/pull-request')
  ...
  , createBranchCleaner = require('./branch-cleaner')
  , async = require('async')
...
function createRepoManager (serviceLocator) {
  ...
  function repoManager (owner, repoName) {
    ...
    function getCommit (sha, cb) {
      ...
      serviceLocator.ghApi.gitdata.getCommit(options, cb)
    }
    ...
    , cleanupBranches: createBranchCleaner(serviceLocator, owner, repoName)
    }
  }
